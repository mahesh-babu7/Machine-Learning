...
model = pickle.load(open(r'D:\VS Code\Regression Models\Salary Prediction\linear_regression_model.pkl', 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by Mahesh Babu")