...
dataset = pd.read_csv(r"D:\VS Code\Machine Learning\Clustering\Hierarchical Clustering\Mall_Customers.csv")
...
dataset["Predicted_Cluster"] = y_hc

dataset.to_csv(r"D:\VS Code\Machine Learning\Clustering\Hierarchical Clustering\Mall_Customers_Predictions.csv")
